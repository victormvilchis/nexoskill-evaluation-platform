...
public final class CategoryCommands {
	...
	public record ChangeStatus(String publicId, CatalogStatus status, long expectedEntityVersion, String reason,
			Long actorUserId, TenantContext tenant) {
	}

	public record Delete(String publicId, long expectedEntityVersion, String reason, Long actorUserId,
