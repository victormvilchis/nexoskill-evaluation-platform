...
public record QuestionCategorySummary(String publicId, String code, String name, String description,
		CatalogStatus status, ContentScope contentScope, String ownerOrganizationPublicId, String ownerOrganizationName,
		long entityVersion, long questionCount, Long createdBy, Instant createdAt, Instant updatedAt) {
}
