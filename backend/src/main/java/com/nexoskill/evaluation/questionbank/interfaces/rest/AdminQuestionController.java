...
public class AdminQuestionController {
	...
	public QuestionDetail update(@PathVariable String id, @Valid @RequestBody QuestionRequests.Update body,
			@AuthenticationPrincipal AuthenticatedUser actor) {
		return update.execute(new UpdateQuestionCommand(id, body.typeCode(), body.categoryPublicIds(), body.statement(),
				body.explanation(), body.promptMediaPublicId(), body.codeContent(), settings(body.answerSettings()),
