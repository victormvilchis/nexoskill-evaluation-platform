...
public final class QuestionRequests {
	...
	public record Create(@NotBlank String typeCode, String difficultyCode, String technologyPublicId, String levelCode,
			@NotEmpty List<String> categoryPublicIds,
			@Size(max = 10, message = "Puedes agregar un máximo de 10 etiquetas.") List<@NotBlank @Size(max = 40, message = "Cada etiqueta puede tener hasta 40 caracteres.") String> tags,
			@NotBlank @Size(max = 10000) String statement, @Size(max = 10000) String explanation,
			String promptMediaPublicId, @Size(max = 30000) String codeContent, @Valid AnswerSettings answerSettings,
			List<@Valid Option> options, String contentScope, String organizationPublicId,
			QuestionAvailabilityMode availabilityMode, List<String> availabilityOrganizationPublicIds) {
		public Create(String typeCode, String difficultyCode, String technologyPublicId, String levelCode,
				List<String> categoryPublicIds, String statement, String explanation, String promptMediaPublicId,
				String codeContent, AnswerSettings answerSettings, List<Option> options) {
			this(typeCode, difficultyCode, technologyPublicId, levelCode, categoryPublicIds, List.of(), statement,
					explanation, promptMediaPublicId, codeContent, answerSettings, options, null, null, null,
					List.of());
		}
	}

	public record Update(@NotBlank String typeCode, String difficultyCode, String technologyPublicId, String levelCode,
			@NotEmpty List<String> categoryPublicIds,
			@Size(max = 10, message = "Puedes agregar un máximo de 10 etiquetas.") List<@NotBlank @Size(max = 40, message = "Cada etiqueta puede tener hasta 40 caracteres.") String> tags,
			@NotBlank @Size(max = 10000) String statement, @Size(max = 10000) String explanation,
			String promptMediaPublicId, @Size(max = 30000) String codeContent, @Valid AnswerSettings answerSettings,
			List<@Valid Option> options, @PositiveOrZero long expectedEntityVersion,
			QuestionAvailabilityMode availabilityMode, List<String> availabilityOrganizationPublicIds) {
		public Update(String typeCode, String difficultyCode, String technologyPublicId, String levelCode,
				List<String> categoryPublicIds, String statement, String explanation, String promptMediaPublicId,
				String codeContent, AnswerSettings answerSettings, List<Option> options, long expectedEntityVersion) {
			this(typeCode, difficultyCode, technologyPublicId, levelCode, categoryPublicIds, List.of(), statement,
					explanation, promptMediaPublicId, codeContent, answerSettings, options, expectedEntityVersion, null,
					List.of());
		}
	}
