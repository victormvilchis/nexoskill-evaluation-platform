...
public class QuestionTechnologyJpaEntity {
	...
	public static QuestionTechnologyJpaEntity create(String publicId, String code, String name, String description,
			int displayOrder, ContentScope contentScope, Long ownerOrganizationId, Long actorId, Instant now) {
	...
	public QuestionTechnologyStatus getStatus() {
		return status;
	}
