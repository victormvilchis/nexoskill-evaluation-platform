...
public record QuestionDetail(String publicId, String statement, String explanation, String typeCode, String typeName,
		List<QuestionCategoryRef> categories, QuestionStatus status, long entityVersion, QuestionMediaView promptMedia,
		String codeLanguage, String codeContent, QuestionAnswerSettings answerSettings,
		List<QuestionOptionView> options, List<QuestionUsageRef> forms, List<QuestionUsageRef> collections,
