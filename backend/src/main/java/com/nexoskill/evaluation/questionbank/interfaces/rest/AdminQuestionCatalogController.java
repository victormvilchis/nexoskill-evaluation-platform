...
public class AdminQuestionCatalogController {
    ...
    public QuestionCategorySummary update(@PathVariable String id,
            @Valid @RequestBody QuestionRequests.UpdateCategory body,
            @AuthenticationPrincipal AuthenticatedUser actor, HttpServletRequest request) {
    ...
    public QuestionCategorySummary activate(@PathVariable String id,
            @Valid @RequestBody QuestionRequests.CategoryStatus body,
            @AuthenticationPrincipal AuthenticatedUser actor, HttpServletRequest request) {
        return service.status(new CategoryCommands.ChangeStatus(id, CatalogStatus.ACTIVE,
    ...
    @PreAuthorize("hasAuthority('QUESTION_CATEGORY_MANAGE')")
    public QuestionCategorySummary delete(@PathVariable String id,
            @Valid @RequestBody QuestionRequests.Delete body,
            @AuthenticationPrincipal AuthenticatedUser actor, HttpServletRequest request) {
    ...
    private CatalogStatus parseStatus(String value) {
        if (value == null || value.isBlank() || "ACTIVE".equalsIgnoreCase(value)) return CatalogStatus.ACTIVE;
