...
/**
 * Guarda preguntas y su disponibilidad transversal dentro de una sola transacción.
 * Una pregunta GLOBAL conserva una única identidad; la disponibilidad para
 * organizaciones se persiste mediante QUESTION_ORGANIZATION_AVAILABILITY y nunca
 * mediante copias físicas implícitas.
 */
@Service
