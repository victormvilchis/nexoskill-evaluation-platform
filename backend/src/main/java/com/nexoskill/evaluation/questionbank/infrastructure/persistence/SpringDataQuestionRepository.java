...
public interface SpringDataQuestionRepository extends JpaRepository<QuestionJpaEntity, Long> {
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<QuestionJpaEntity> findActiveForForm(@Param("targetGlobal") int targetGlobal,
			@Param("organizationId") Long organizationId, @Param("query") String query,
			@Param("categoryPublicId") String categoryPublicId, Pageable pageable);
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<QuestionJpaEntity> searchWithoutText(@Param("status") String status, @Param("typeCode") String typeCode,
			@Param("categoryPublicId") String categoryPublicId, @Param("globalScope") int globalScope,
			@Param("organizationId") Long organizationId, @Param("allGlobalContent") int allGlobalContent,
			Pageable pageable);
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<QuestionJpaEntity> searchWithText(@Param("query") String query, @Param("status") String status,
			@Param("typeCode") String typeCode, @Param("categoryPublicId") String categoryPublicId,
			@Param("globalScope") int globalScope, @Param("organizationId") Long organizationId,
			@Param("allGlobalContent") int allGlobalContent, Pageable pageable);
	...
	boolean existsBySourceGlobalIdAndOwnerOrganizationIdAndStatusNot(Long sourceGlobalId, Long ownerOrganizationId,
			com.nexoskill.evaluation.questionbank.domain.model.QuestionStatus status);
}
