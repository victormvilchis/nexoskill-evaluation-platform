...
/**
 * Keeps the editor's immutable catalogs independent from tenant-owned
 * categories and optional technology catalogs. Categories are loaded through
 * the dedicated question-options query with the effective question owner.
 */
@Component
@Primary
public class QuestionEditorCatalogPortDecorator implements QuestionCatalogPort {
	...
	public QuestionEditorCatalogPortDecorator(OracleQuestionCatalogAdapter delegate,
			SpringDataQuestionTypeRepository types, SpringDataQuestionDifficultyRepository difficulties) {
	...
	public List<com.nexoskill.evaluation.questionbank.application.model.QuestionTechnologySummary> technologyOptions(
			TenantContext tenant, String questionPublicId, String targetScope, String organizationPublicId) {
