...
public class QuestionValidator {
	...
	public void validate(QuestionTypeCode type, String statement, List<String> categories,
			QuestionAnswerSettings settings, List<QuestionOptionCommand> options, String codeContent) {
		...
		for (QuestionOptionCommand option : options) {
			...
			if (type == QuestionTypeCode.MATCHING) {
				...
				if (!seenMatches.add(matchKey)) {
					throw error("DUPLICATE_MATCH_OPTION", "La columna derecha contiene elementos duplicados.");
				}
				continue;
			}
