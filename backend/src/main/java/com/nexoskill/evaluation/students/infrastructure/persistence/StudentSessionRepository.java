...
public interface StudentSessionRepository extends JpaRepository<StudentSessionJpaEntity, Long> {
    ...
    int expireElapsedSessions(@Param("active") StudentSessionStatus active,
            @Param("expired") StudentSessionStatus expired,
            @Param("reason") StudentSessionRevocationReason reason,
    ...
    @Query("""
        ...
        """)
    int revokeActive(@Param("studentId") Long studentId,
            @Param("active") StudentSessionStatus active,
            @Param("revoked") StudentSessionStatus revoked,
            @Param("reason") StudentSessionRevocationReason reason,
            @Param("now") Instant now);
