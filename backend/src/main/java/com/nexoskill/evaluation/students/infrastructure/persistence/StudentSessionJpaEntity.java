...
public class StudentSessionJpaEntity {
	...
	public static StudentSessionJpaEntity create(String publicId, Long studentId, Long organizationId, String tokenHash,
	...
	public StudentSessionStatus getStatus() {
		return status;
	}
	...
	public StudentSessionRevocationReason getRevocationReason() {
