...
public class TalentCvJpaEntity {
	...
	public static TalentCvJpaEntity create(String publicId, Long studentId, Long organizationId, String fileName,
			String contentType, String extension, byte[] data, Long actorId, Instant now) {
	...
	public void replace(String fileName, String contentType, String extension, byte[] data, Long actorId, Instant now) {
	...
	public byte[] getFileData() {
		return fileData == null ? new byte[0] : fileData.clone();
	}
