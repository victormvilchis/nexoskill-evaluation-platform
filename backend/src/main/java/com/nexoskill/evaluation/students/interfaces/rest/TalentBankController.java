...
public class TalentBankController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('TALENT_VIEW')")
    ...
    @PostMapping("/academy")
    @PreAuthorize("hasAuthority('TALENT_CREATE')")
    ...
    @PreAuthorize("hasAuthority('TALENT_UPDATE')")
    ...
    @PreAuthorize("hasAuthority('TALENT_CONVERT')")
