...
public class StudentJpaEntity {
    ...
    public static StudentJpaEntity create(String publicId, Long organizationId, String studentCode,
            String email, String normalizedEmail, String passwordHash, String firstName, String lastName,
            String displayName, StudentStatus status, Instant validFrom, Instant expiresAt,
            Instant temporaryPasswordExpiresAt, Long actorId, Instant now) {
    ...
    public boolean isTemporaryPasswordExpiredAt(Instant now) {
        return passwordChangeRequired && temporaryPasswordExpiresAt != null
