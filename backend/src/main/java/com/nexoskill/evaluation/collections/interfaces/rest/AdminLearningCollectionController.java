...
public class AdminLearningCollectionController {
	...
	private static final Map<String, String> ALLOWED_SORTS = Map.of("name", "name", "code", "code", "status", "status",
	...
	public PagedResponse<LearningCollectionModels.CollectionSummary> list(@RequestParam(required = false) String query,
	...
	public LearningCollectionModels.CollectionDetail changeStatus(@PathVariable String publicId,
			@PathVariable String status, @AuthenticationPrincipal AuthenticatedUser actor) {
