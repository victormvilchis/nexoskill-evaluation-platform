...
public class AuditEventJpaEntity {
	...
	public static AuditEventJpaEntity create(String publicId, Long userId, String eventType, String moduleCode,
			String description, String ipAddress, String userAgent, String eventData, Instant occurredAt) {
