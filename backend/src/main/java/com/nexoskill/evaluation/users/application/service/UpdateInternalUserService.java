...
public class UpdateInternalUserService {
	...
	public UpdateInternalUserService(UserManagementPort users, UserSessionPort sessions, InternalRolePolicy rolePolicy,
	...
	public AdminUserSummary update(UpdateInternalUserCommand command) {
		...
		if (self && !Objects.equals(before.organizationPublicId(),
				normalizeOrganization(command.organizationPublicId()))) {
