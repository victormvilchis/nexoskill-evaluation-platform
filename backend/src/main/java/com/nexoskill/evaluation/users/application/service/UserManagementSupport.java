...
final class UserManagementSupport {
	...
	static void validatePassword(String password) {
		boolean valid = password != null && password.length() >= 10 && password.chars().anyMatch(Character::isUpperCase)
	...
	static String displayName(String firstName, String lastName, String requestedDisplayName) {
	...
	static Map<String, Object> auditData(AdminUserSummary before, AdminUserSummary after) {
