...
public class UserAccessJpaEntity {
	...
	public static UserAccessJpaEntity create(UserJpaEntity user, Instant startsAt, Instant expiresAt) {
	...
	public void updatePeriod(Instant startsAt, Instant expiresAt, Instant updatedAt) {
		this.startsAt = startsAt;
		this.expiresAt = expiresAt;
		this.updatedAt = updatedAt;
	}

	public void changeStatus(UserAccessStatus status, Instant updatedAt) {
		this.status = status;
		this.updatedAt = updatedAt;
	}
