...
public class InternalUserTransitionPolicy {
    private static final Map<UserStatus, Set<UserStatus>> ALLOWED = Map.of(
            UserStatus.ACTIVE, Set.of(UserStatus.INACTIVE, UserStatus.SUSPENDED, UserStatus.DELETED),
            UserStatus.INACTIVE, Set.of(UserStatus.ACTIVE, UserStatus.SUSPENDED, UserStatus.DELETED),
            UserStatus.SUSPENDED, Set.of(UserStatus.ACTIVE, UserStatus.INACTIVE, UserStatus.DELETED),
            UserStatus.DELETED, Set.of(UserStatus.INACTIVE));
