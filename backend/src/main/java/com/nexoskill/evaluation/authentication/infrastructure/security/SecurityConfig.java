...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource(AppProperties properties) {
        ...
        configuration.setAllowedOrigins(
                properties.getSecurity().getAllowedOrigins()
        );
        configuration.setAllowedMethods(
                List.of("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS")
        );
        configuration.setAllowedHeaders(
                List.of("Content-Type", "Accept", "X-Requested-With")
        );
    ...
    @Bean
    FilterRegistrationBean<OriginProtectionFilter> originFilterRegistration(
            OriginProtectionFilter filter) {
        FilterRegistrationBean<OriginProtectionFilter> registration =
