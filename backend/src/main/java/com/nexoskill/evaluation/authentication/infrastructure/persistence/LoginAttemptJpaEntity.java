...
public class LoginAttemptJpaEntity {
	...
	public static LoginAttemptJpaEntity create(Long userId, String attemptedEmail, boolean successful,
			String failureReason, String ipAddress, String userAgent, Instant attemptedAt) {
