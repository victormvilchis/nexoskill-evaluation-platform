...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiErrorResponse> handleBusiness(BusinessException exception, HttpServletRequest request) {
		...
		case "QUESTION_CONCURRENT_MODIFICATION", "USER_CONCURRENT_MODIFICATION", "DATA_CONFLICT",
				...
				"COLLECTION_ALREADY_EXISTS", "ORGANIZATION_CODE_EXISTS",
				"ORGANIZATION_CONCURRENT_MODIFICATION", "STUDENT_EMAIL_EXISTS", "STUDENT_CODE_EXISTS",
				"STUDENT_CONFLICT", "STUDENT_VERSION_CONFLICT", "STUDENT_SESSION_ALREADY_ACTIVE" ->
			HttpStatus.CONFLICT;
		...
		case "STUDENT_INVALID_CREDENTIALS", "STUDENT_ACCOUNT_UNAVAILABLE",
				"STUDENT_ACCESS_EXPIRED", "STUDENT_TEMP_PASSWORD_EXPIRED" ->
