...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiErrorResponse> handleAuthentication(AuthenticationException exception,
		...
		return response(exception.getStatus(), exception.getCode(), exception.getMessage(), request.getRequestURI(),
                null);
	}
	...
	public ResponseEntity<ApiErrorResponse> handleBusiness(BusinessException exception, HttpServletRequest request) {
		...
		case "QUESTION_CONCURRENT_MODIFICATION", "USER_CONCURRENT_MODIFICATION", "DATA_CONFLICT",
				...
				"COLLECTION_ALREADY_EXISTS", "ORGANIZATION_CODE_EXISTS", "ORGANIZATION_CONCURRENT_MODIFICATION",
				...
				"USER_NOT_DELETED", "USER_DELETED" -> HttpStatus.CONFLICT;
		case "QUESTION_NOT_FOUND", "CATEGORY_NOT_FOUND", "COLLECTION_NOT_FOUND", "USER_NOT_FOUND",
				"ORGANIZATION_NOT_FOUND", "ORGANIZATION_LICENSE_NOT_FOUND", "STUDENT_NOT_FOUND",
				"STUDENT_SESSION_NOT_FOUND" -> HttpStatus.NOT_FOUND;
		...
		case "SELF_DEACTIVATE_NOT_ALLOWED", "SELF_DELETE_NOT_ALLOWED", "SELF_SUSPEND_NOT_ALLOWED",
				...
				"LAST_ADMINISTRATOR_REQUIRED" -> HttpStatus.FORBIDDEN;
