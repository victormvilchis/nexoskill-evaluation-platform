...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiErrorResponse> handleAuthentication(AuthenticationException exception,
		...
		case "ACCOUNT_INACTIVE", "ACCOUNT_SUSPENDED", "ACCOUNT_TEMPORARILY_LOCKED", "ORGANIZATION_INACTIVE",
				"ORGANIZATION_EXPIRED", "ACCESS_EXPIRED" ->
	...
	public ResponseEntity<ApiErrorResponse> handleBusiness(BusinessException exception, HttpServletRequest request) {
		...
		case "QUESTION_CONCURRENT_MODIFICATION", "USER_CONCURRENT_MODIFICATION", "DATA_CONFLICT",
				...
				"USER_EMAIL_EXISTS", "USER_STATUS_TRANSITION_INVALID", "USER_NOT_DELETED", "USER_DELETED",
				"GLOBAL_CONTENT_ALREADY_PROMOTED", "GLOBAL_CONTENT_DEPENDENCIES_MISSING",
				"GLOBAL_CONTENT_DEPENDENCY_CYCLE", "GLOBAL_CONTENT_EDITORIAL_TRANSITION_INVALID",
				"GLOBAL_CONTENT_NOT_PUBLISHED", "GLOBAL_CONTENT_CUSTOMIZED_COPY", "GLOBAL_CONTENT_GRANT_ALREADY_EXISTS",
				...
				"QUESTION_DUPLICATE_CONFIGURATION_INVALID", "QUESTION_HISTORY_EXISTS", "STUDENT_DELETION_IN_PROGRESS",
				...
				"STUDENT_IMPORT_APPLY_IN_PROGRESS", "CATALOG_DUPLICATE", "CATALOG_IN_USE",
				"CATALOG_CONCURRENT_MODIFICATION", "CATALOG_MUST_BE_INACTIVE" ->
			HttpStatus.CONFLICT;
		case "QUESTION_NOT_FOUND", "CATEGORY_NOT_FOUND", "COLLECTION_NOT_FOUND", "USER_NOT_FOUND",
				...
				"QUESTION_DUPLICATE_SOURCE_NOT_FOUND", "QUESTION_MEDIA_NOT_FOUND", "CERTIFICATION_CYCLE_NOT_FOUND",
				"CERTIFICATION_ATTEMPT_NOT_FOUND", "CATALOG_ITEM_NOT_FOUND" ->
			HttpStatus.NOT_FOUND;
		case "STUDENT_INVALID_CREDENTIALS", "STUDENT_ACCOUNT_UNAVAILABLE", "STUDENT_ACCESS_EXPIRED",
				"STUDENT_TEMP_PASSWORD_EXPIRED" ->
			HttpStatus.UNAUTHORIZED;
		case "SELF_DEACTIVATE_NOT_ALLOWED", "SELF_DELETE_NOT_ALLOWED", "SELF_SUSPEND_NOT_ALLOWED",
				"SELF_ROLE_CHANGE_NOT_ALLOWED", "SELF_ORGANIZATION_CHANGE_NOT_ALLOWED", "LAST_ADMINISTRATOR_REQUIRED",
				"CATEGORY_GLOBAL_IMMUTABLE", "CATEGORY_GLOBAL_CONTEXT_REQUIRED", "CATEGORY_TENANT_INVALID",
				"TENANT_NOT_RESOLVED", "ORGANIZATION_CONTEXT_REQUIRED", "ADMIN_GLOBAL_ORGANIZATION_REQUIRED",
				"CUSTOMER_ORGANIZATION_REQUIRED", "ORGANIZATION_NOT_OPERATIONAL", "GLOBAL_CONTENT_SCOPE_REQUIRED",
				...
				"QUESTION_ACCESS_FORBIDDEN", "QUESTION_DUPLICATE_FORBIDDEN", "QUESTION_GLOBAL_MANAGEMENT_FORBIDDEN",
				"QUESTION_OPERATION_FORBIDDEN", "STUDENT_DELETE_FORBIDDEN", "STUDENT_ORGANIZATION_FORBIDDEN",
				"STUDENT_GLOBAL_FORBIDDEN", "CERTIFICATION_ACCESS_FORBIDDEN", "CERTIFICATION_OPERATION_FORBIDDEN",
				"CERTIFICATIONS_NOT_ENABLED" ->
			HttpStatus.FORBIDDEN;
		case "CATALOG_USAGE_CHECK_FAILED", "CATALOG_DUPLICATE_CHECK_FAILED" -> HttpStatus.SERVICE_UNAVAILABLE;
		case "ORGANIZATION_PERSISTENCE_INVALID", "ORGANIZATION_LICENSE_PERSISTENCE_INVALID",
				"ORGANIZATION_CREATE_FAILED", "QUESTION_GLOBAL_CLONE_FAILED", "STUDENT_PERMANENT_DELETE_FAILED",
				"QUESTION_DUPLICATE_FAILED", "QUESTION_MEDIA_STORAGE_ERROR", "QUESTION_MEDIA_READ_ERROR",
				"QUESTION_MEDIA_DELETE_ERROR", "CATALOG_OPERATION_FAILED" ->
	...
	public ResponseEntity<ApiErrorResponse> handleUnreadable(HttpMessageNotReadableException exception,
			HttpServletRequest request) {
		LOGGER.warn("Invalid request payload on {} ({})", request.getRequestURI(), diagnosticType(exception));
		...
		return response(HttpStatus.BAD_REQUEST, "VALIDATION_ERROR", "La solicitud contiene un formato inválido.",
				request.getRequestURI(), Map.of(field, fieldMessage));
	}

	@ExceptionHandler(AccessDeniedException.class)
	public ResponseEntity<ApiErrorResponse> handleAccessDenied(AccessDeniedException exception,
			HttpServletRequest request) {
		LOGGER.warn("Access denied on {} ({})", request.getRequestURI(), diagnosticType(exception));
	...
	public ResponseEntity<ApiErrorResponse> handleMaxUploadSize(MaxUploadSizeExceededException exception,
		...
		return response(HttpStatus.PAYLOAD_TOO_LARGE, "STUDENT_IMPORT_FILE_TOO_LARGE",
				"El archivo supera el límite de 50 MB permitido para la importación.", request.getRequestURI(), null);
	}

	@ExceptionHandler(MultipartException.class)
	public ResponseEntity<ApiErrorResponse> handleMultipart(MultipartException exception, HttpServletRequest request) {
		LOGGER.warn("Invalid multipart request on {} ({})", request.getRequestURI(), diagnosticType(exception));
