...
public class GlobalContentPromotionJpaEntity {
	...
	public static GlobalContentPromotionJpaEntity create(String publicId, Long sourceOrganizationId,
			GlobalContentType contentType, Long sourceContentId, String sourceContentPublicId, long sourceVersion,
			Long sourceAuthorId, Long globalContentId, String globalContentPublicId, long globalVersion, String notes,
			String functionalHash, Long actor, Instant now) {
	...
	public String getSourceContentPublicId() {
		return sourceContentPublicId;
	}
	...
	public String getFunctionalHash() {
