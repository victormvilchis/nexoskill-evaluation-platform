...
public class ContentReplicationLinkJpaEntity {
    ...
    public static ContentReplicationLinkJpaEntity create(
            String publicId,
            Long organizationId,
            GlobalContentType contentType,
            Long sourceGlobalContentId,
            String sourceGlobalPublicId,
            long sourceGlobalVersion,
    ...
    public void markUpdateAvailable() {
        if (!isCustomized()) syncStatus = SyncStatus.UPDATE_AVAILABLE;
    }
    ...
    public Long getSourceGlobalContentId() { return sourceGlobalContentId; }
    public String getSourceGlobalPublicId() { return sourceGlobalPublicId; }
