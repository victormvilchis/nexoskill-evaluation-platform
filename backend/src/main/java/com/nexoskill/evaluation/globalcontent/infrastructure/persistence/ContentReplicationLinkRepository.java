...
public interface ContentReplicationLinkRepository extends JpaRepository<ContentReplicationLinkJpaEntity, Long> {
    ...
    Optional<ContentReplicationLinkJpaEntity> findByOrganizationIdAndContentTypeAndTargetContentId(
            Long organizationId, GlobalContentType contentType, Long targetContentId);
}
