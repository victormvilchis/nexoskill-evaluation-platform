...
public interface OrganizationGlobalContentGrantRepository extends JpaRepository<OrganizationGlobalContentGrantJpaEntity, Long> {
    ...
    boolean existsByOrganizationIdAndContentTypeAndGlobalContentIdAndStatus(
