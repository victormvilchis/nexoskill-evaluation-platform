...
public class ContentDistributionResultJpaEntity {
	...
	public static ContentDistributionResultJpaEntity success(Long jobId, Long organizationId, Long grantId,
			Long targetContentId, String targetContentPublicId, Instant now) {
	...
	public static ContentDistributionResultJpaEntity skipped(Long jobId, Long organizationId, Long grantId,
			Long targetContentId, String targetContentPublicId, Instant now) {
		ContentDistributionResultJpaEntity entity = base(jobId, organizationId, now);
	...
	public static ContentDistributionResultJpaEntity failed(Long jobId, Long organizationId, String errorCode,
	...
	public DistributionResultStatus getStatus() {
		return status;
	}
