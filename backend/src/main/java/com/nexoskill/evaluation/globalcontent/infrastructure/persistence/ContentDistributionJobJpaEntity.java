...
public class ContentDistributionJobJpaEntity {
    ...
    public static ContentDistributionJobJpaEntity create(
            String publicId,
    ...
    public void finish(Instant now) {
        finishedAt = now;
        status = failedOrganizations == 0
                ? DistributionJobStatus.COMPLETED
                : successfulOrganizations > 0 || skippedOrganizations > 0
                    ? DistributionJobStatus.COMPLETED_WITH_ERRORS
    ...
    public DistributionJobStatus getStatus() { return status; }
    public int getTotalOrganizations() { return totalOrganizations; }
    public int getProcessedOrganizations() { return processedOrganizations; }
    public int getSuccessfulOrganizations() { return successfulOrganizations; }
    public int getFailedOrganizations() { return failedOrganizations; }
    public int getSkippedOrganizations() { return skippedOrganizations; }
