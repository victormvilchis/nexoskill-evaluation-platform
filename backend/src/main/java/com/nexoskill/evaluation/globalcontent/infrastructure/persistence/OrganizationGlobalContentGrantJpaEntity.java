...
public class OrganizationGlobalContentGrantJpaEntity {
    ...
    public static OrganizationGlobalContentGrantJpaEntity create(
            String publicId,
            Long organizationId,
    ...
    public boolean isCloningAllowed() { return Integer.valueOf(1).equals(cloningAllowed); }
    public boolean isOrganizationEditable() { return Integer.valueOf(1).equals(organizationEditable); }
