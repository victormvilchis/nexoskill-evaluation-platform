...
public class GlobalContentVersionJpaEntity {
	...
	public static GlobalContentVersionJpaEntity create(String publicId, GlobalContentType contentType, Long contentId,
			String contentPublicId, long versionNumber, Long promotionId, String functionalHash, String changeNotes,
	...
	public String getContentPublicId() {
		return contentPublicId;
	}
