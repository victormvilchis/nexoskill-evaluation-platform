...
public final class FormModels {
    ...
    /** Compatibilidad de lectura con formularios construidos antes de la homologación del contenido. */
    ...
    public record QuestionView(String questionPublicId, String statement, String typeCode, String typeName,
            ...
            String contentScope, String organizationName, String explanation, QuestionMedia promptMedia,
            String codeLanguage, String codeContent, String acceptedAnswersJson,
    ...
    public record PoolView(String publicId, String categoryPublicId, String categoryName,
            Integer questionCount, String difficultyCode, Integer order, Integer availableQuestionCount) {
    }

    public record QuestionMedia(String publicId, String originalName, String contentType, long size, String url) { }

    public record QuestionAnswerOption(String publicId, Integer order, String text, QuestionMedia media,
            String matchText, QuestionMedia matchMedia, boolean correct, String feedback) { }
    ...
    public record QuestionOptionView(String publicId, String statement, String typeCode, String typeName,
            ...
            QuestionMedia promptMedia, String codeLanguage, String codeContent, String acceptedAnswersJson,
            List<QuestionAnswerOption> options, BigDecimal defaultPoints) {
    ...
    public record QuestionOptionPage(List<QuestionOptionView> content, int page, int size,
