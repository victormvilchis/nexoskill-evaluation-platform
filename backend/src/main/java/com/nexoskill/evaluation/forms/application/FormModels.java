...
public final class FormModels {
	...
	public record FormCommand(String title, String description, String modeCode, java.math.BigDecimal passingScore,
	...
	public record FormSummary(String publicId, String code, String title, String status, String modeCode,
			java.math.BigDecimal passingScore, Integer sectionCount, Integer questionCount, OffsetDateTime startsAt,
			OffsetDateTime endsAt, Long version) {
	}

	public record FormDetail(String publicId, String code, String title, String description, String status,
			String modeCode, java.math.BigDecimal passingScore, Integer maxAttempts, boolean retryUntilPassed,
			...
			String thankYouMessage, Long version, List<SectionView> sections) {
	}

	public record SectionView(String publicId, String title, String description, Integer order,
			List<QuestionView> questions, List<PoolView> pools) {
	}

	public record QuestionView(String questionPublicId, String statement, Integer order, java.math.BigDecimal points,
			boolean required) {
	}

	public record PoolView(String publicId, String sourceType, String sourcePublicId, String sourceName,
			Integer questionCount, String difficultyCode, Integer order) {
	}
}
