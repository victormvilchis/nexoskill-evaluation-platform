...
public class FormSectionJpaEntity {
    ...
    public void addPool(String publicId, Long categoryId, int questionCount, String difficultyCode, int order) {
        pools.add(FormQuestionPoolJpaEntity.category(this, publicId, categoryId, questionCount,
                difficultyCode, order));
    }
    ...
    public List<FormQuestionJpaEntity> getQuestions() { return List.copyOf(questions); }
    public List<FormQuestionPoolJpaEntity> getPools() { return List.copyOf(pools); }
}
