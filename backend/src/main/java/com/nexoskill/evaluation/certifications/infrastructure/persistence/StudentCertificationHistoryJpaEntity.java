...
public class StudentCertificationHistoryJpaEntity {
    ...
    @Column(name = "STUDENT_CERTIFICATION_HISTORY_ID") private Long id;
    ...
    @Column(name = "STUDENT_CERT_REQUIREMENT_ID") private Long requirementId;
    @Column(name = "EVENT_TYPE", nullable = false, length = 80) private String eventType;
    @Lob @Column(name = "PREVIOUS_VALUES") private String previousValues;
    ...
    public static StudentCertificationHistoryJpaEntity create(Long studentId, Long organizationId,
            Long requirementId, String eventType, String previousValues, String newValues,
