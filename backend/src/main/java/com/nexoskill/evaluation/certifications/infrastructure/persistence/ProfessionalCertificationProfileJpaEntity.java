...
public class ProfessionalCertificationProfileJpaEntity {
	...
	@Column(name = "CERTIFICATION_PROFILE_ID")
	private Long id;
	...
	@Column(name = "SUGGESTED_TECH_PROFILE", length = 40)
	private String suggestedTechnologicalProfile;
	...
	public static ProfessionalCertificationProfileJpaEntity create(String publicId, String code, String name,
			String description, int sortOrder, String suggested, ContentScope contentScope, Long ownerOrganizationId,
	...
	public void update(String name, String description, int sortOrder, String suggested, Long actorId, Instant now) {
		this.name = name;
	...
	public String getSuggestedTechnologicalProfile() {
		return suggestedTechnologicalProfile;
	}
