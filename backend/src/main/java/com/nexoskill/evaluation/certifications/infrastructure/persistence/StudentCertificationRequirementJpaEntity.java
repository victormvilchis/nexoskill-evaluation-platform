...
public class StudentCertificationRequirementJpaEntity {
	...
	@Column(name = "STUDENT_CERTIFICATION_PROFILE_ID", nullable = false)
	private Long profileId;
	@Column(name = "ORGANIZATION_ID", nullable = false)
	private Long organizationId;
	@Enumerated(EnumType.STRING)
	@Column(name = "CERTIFICATION_TYPE", nullable = false, length = 40)
	...
	@Column(name = "CALCULATED_DEADLINE")
	private LocalDate calculatedDeadline;
	@Column(name = "MANUAL_DEADLINE")
	private LocalDate manualDeadline;
	@Column(name = "DEADLINE_OVERRIDE_REASON", length = 500)
	private String deadlineOverrideReason;
	@Column(name = "DEADLINE_ADJUSTED_BY")
	private Long deadlineAdjustedBy;
	@Column(name = "DEADLINE_ADJUSTED_AT")
	private Instant deadlineAdjustedAt;
	...
	@Column(name = "ACTIONS_TO_TAKE", length = 1000)
	...
	public void update(boolean applies, CertificationStatus certificationStatus, CertificationExamStatus examStatus,
			LocalDate calculatedDeadline, LocalDate manualDeadline, String deadlineOverrideReason,
			LocalDate applicationDate, BigDecimal score, Integer currentAttempt, String actionsToTake,
			String observations, Long actorId, Instant now) {
	...
	public LocalDate effectiveDeadline() {
		return manualDeadline == null ? calculatedDeadline : manualDeadline;
	}
	...
	public LocalDate getCalculatedDeadline() {
		return calculatedDeadline;
	}

	public LocalDate getManualDeadline() {
		return manualDeadline;
	}

	public String getDeadlineOverrideReason() {
		return deadlineOverrideReason;
	}
