...
public class StudentCertificationProfileJpaEntity {
	...
	@Column(name = "STUDENT_CERTIFICATION_PROFILE_ID")
	private Long id;
	...
	@Column(name = "CERTIFICATION_TECHNOLOGY_ID", nullable = false)
	private Long certificationTechnologyId;
	@Column(name = "ENROLLMENT_DATE", nullable = false)
	private LocalDate enrollmentDate;
	@Column(name = "TECHNOLOGICAL_PROFILE", nullable = false, length = 40)
	private String technologicalProfile;
	...
	public static StudentCertificationProfileJpaEntity create(Long studentId, Long organizationId,
			Long professionalProfileId, Long technologyId, LocalDate enrollmentDate, String technologicalProfile,
	...
	public Long getCertificationTechnologyId() {
		return certificationTechnologyId;
	}
	...
	public String getTechnologicalProfile() {
		return technologicalProfile;
	}
