...
public final class CertificationModels {
	...
	public record Availability(boolean appliesCertifications, boolean operatorAllowed, String organizationPublicId,
	...
	public record Catalogs(List<CatalogItem> profiles, List<CatalogItem> technologies,
			List<CatalogItem> technologicalProfiles, List<EnumOption> levels, List<EnumOption> trackingStatuses,
	...
	public record StudentSummary(String publicId, String displayName, String organizationPublicId,
			String organizationName, String status, LocalDate validFrom, LocalDate expiresAt, LocalDate admissionDate,
			CatalogItem professionalProfile, CatalogItem technologicalProfile) {
	}

	public record Applicability(boolean technological, boolean developmentSecurity, boolean normativeTesting,
			boolean one, boolean agile, boolean jira) {
	}

	public record Metrics(int applicableAreas, int pending, int scheduled, int approved, int notApproved, int valid,
	...
	public record CycleView(String publicId, CertificationType type, String technologyPublicId, String technologyName,
			...
			LocalDate applicationDate, LocalDate lastApprovedApplicationDate, Boolean approved,
			LocalDate expirationDate, CertificationValidityStatus validityStatus, String previousApprovedCyclePublicId,
			String actionsToTake, String softtekManagement, String observations, boolean active, BigDecimal latestScore,
			CertificationExamStatus latestExamStatus, Integer attemptCount, Integer importedFailureCount,
			String resultSource, Long version) {
	}

	public record AttemptView(String publicId, String cyclePublicId, int attemptNumber, LocalDate scheduledDate,
			LocalDate applicationDate, CertificationExamStatus examStatus, BigDecimal score, Boolean approved,
			String result, String observations, Instant createdAt, Long version) {
	}

	public record HistoryView(String publicId, String eventType, String previousValues, String newValues, String reason,
			Instant changedAt) {
	}
	...
	public record CycleCommand(String publicId, CertificationType type, String technologyPublicId,
			CertificationLevel certificationLevel, boolean primary, CertificationTrackingStatus trackingStatus,
			LocalDate scheduledDate, LocalDate applicationDate, Boolean approved, String actionsToTake,
			String softtekManagement, String observations, boolean active, Long version,
	...
	public record AttemptCommand(String publicId, LocalDate scheduledDate, LocalDate applicationDate,
			CertificationExamStatus examStatus, BigDecimal score, Boolean approved, String result, String observations,
			Long version) {
	}
}
