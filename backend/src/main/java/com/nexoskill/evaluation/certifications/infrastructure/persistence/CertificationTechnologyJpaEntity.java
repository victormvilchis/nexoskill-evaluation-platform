...
public class CertificationTechnologyJpaEntity {
	...
	@Column(name = "CERTIFICATION_TECHNOLOGY_ID")
	private Long id;
	@Column(name = "PUBLIC_ID", nullable = false, length = 36, unique = true)
	private String publicId;
	@Column(name = "TECHNOLOGY_CODE", nullable = false, length = 120, unique = true)
	private String code;
	...
	@Column(name = "MASTER_TECHNOLOGY_ID")
	private Long masterTechnologyId;
	...
	public void synchronizeWithMaster(String name, String status, int sortOrder, Long masterTechnologyId, Instant now) {
		this.name = name;
		this.status = status;
	...
	public Long getMasterTechnologyId() {
		return masterTechnologyId;
	}
}
