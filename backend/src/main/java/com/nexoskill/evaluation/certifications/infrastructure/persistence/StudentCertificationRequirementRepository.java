...
public interface StudentCertificationRequirementRepository extends JpaRepository<StudentCertificationRequirementJpaEntity, Long> {
    List<StudentCertificationRequirementJpaEntity> findAllByProfileIdOrderByCertificationTypeAsc(Long profileId);
    Optional<StudentCertificationRequirementJpaEntity> findByProfileIdAndCertificationType(Long profileId, CertificationType type);
}
