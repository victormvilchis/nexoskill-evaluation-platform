...
@Entity
@Table(name = "ORGANIZATION_CERTIFICATION_POLICY", uniqueConstraints = @UniqueConstraint(name = "UK_ORG_CERT_POLICY_TYPE", columnNames = {
		"ORGANIZATION_ID", "CERTIFICATION_TYPE" }))
public class OrganizationCertificationPolicyJpaEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ORGANIZATION_CERT_POLICY_ID")
	private Long id;
	...
	public boolean isAppliesByDefault() {
		return appliesByDefault;
	}

	public Integer getDeadlineMonths() {
