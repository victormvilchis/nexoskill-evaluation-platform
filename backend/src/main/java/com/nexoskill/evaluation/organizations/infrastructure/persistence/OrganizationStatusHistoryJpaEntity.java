...
public class OrganizationStatusHistoryJpaEntity {
    ...
    public static OrganizationStatusHistoryJpaEntity create(Long organizationId,
            OrganizationStatus previousStatus, OrganizationStatus newStatus,
    ...
    public OrganizationStatus getPreviousStatus() { return previousStatus; }
    public OrganizationStatus getNewStatus() { return newStatus; }
