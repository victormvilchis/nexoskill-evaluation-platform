...
public class OrganizationLicensePolicyJpaEntity {
	...
	public static OrganizationLicensePolicyJpaEntity create(Long organizationId, int seats, int included,
			int additional, int releaseHours, int exhaustedDays, LocalDate cycleStart, LocalDate cycleEnd,
			Instant now) {
	...
	public Integer getIncludedReplacements() {
		return includedReplacements;
	}

	public Integer getAdditionalReplacements() {
		return additionalReplacements;
	}

	public Integer getStandardReleaseHours() {
		return standardReleaseHours;
	}

	public Integer getExhaustedReleaseDays() {
		return exhaustedReleaseDays;
	}

	public LocalDate getCycleStartsOn() {
		return cycleStartsOn;
	}

	public LocalDate getCycleEndsOn() {
		return cycleEndsOn;
	}
