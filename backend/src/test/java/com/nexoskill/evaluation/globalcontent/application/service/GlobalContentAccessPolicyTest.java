...
class GlobalContentAccessPolicyTest {
    ...
    void anExplicitReferenceGrantAllowsCleanOrganizationsToReadGlobalContent() {
        ...
        when(grants.findAllByOrganizationIdAndContentTypeAndGlobalContentIdAndStatus(
                21L, GlobalContentType.QUESTION, 100L, GrantStatus.ACTIVE)).thenReturn(List.of(grant));
    ...
    void promotedDraftContentIsNotVisibleToCustomerOrganizations() {
        ...
        when(versions.findFirstByContentTypeAndContentIdAndStatusOrderByVersionNumberDesc(
                GlobalContentType.QUESTION, 100L,
