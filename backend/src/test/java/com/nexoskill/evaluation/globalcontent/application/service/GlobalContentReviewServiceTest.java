...
class GlobalContentReviewServiceTest {
	...
	void rejectsPageSizesOutsideTheHomogeneousContract() {
		...
		GlobalContentReviewService service = new GlobalContentReviewService(resources, mock(AuditLogPort.class), CLOCK);
		ReviewFilter filter = new ReviewFilter(null, null, null, ContentScope.GLOBAL, null, null, null, null, null,
				null, 0, 20);

		assertThatThrownBy(() -> service.review(filter, 7L)).isInstanceOfSatisfying(BusinessException.class,
