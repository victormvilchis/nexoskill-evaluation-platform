...
class CreateUserServiceTest {
    ...
    void shouldAlwaysCreateInternalUsersAsActive() {
        ...
        when(users.getByPublicId("user-public"))
        ...
        service.create(new CreateUserCommand("manager@example.com", "María", "López", null, "MANAGER",
                "org-public", NOW, null, 1L, "127.0.0.1", "browser"));

        ArgumentCaptor<UserManagementPort.NewUserData> captor =
                ArgumentCaptor.forClass(UserManagementPort.NewUserData.class);
    ...
    private static AdminUserSummary summary() {
        return new AdminUserSummary("user-public", "manager@example.com", "María", "López", "María López",
                UserStatus.ACTIVE, Set.of("MANAGER"), "org-public", "Acme", UserAccessStatus.ACTIVE,
                NOW, null, null, NOW, NOW, "Administrador", "Creación de usuario");
    }
}
