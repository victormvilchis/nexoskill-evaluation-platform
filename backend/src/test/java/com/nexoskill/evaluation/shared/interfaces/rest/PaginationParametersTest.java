...
class PaginationParametersTest {
    ...
    void usesTenRecordsAndStableSort() {
        var pageable = PaginationParameters.of(0, 10, "createdAt", "DESC", SORTS,
    ...
    void acceptsOnlyHomologatedSizes() {
        assertThatThrownBy(() -> PaginationParameters.validate(0, 20))
    ...
    void rejectsNegativePages() {
        assertThatThrownBy(() -> PaginationParameters.validate(-1, 10))
                .isInstanceOf(BusinessException.class);
    }

    @Test
    void rejectsUnknownSorts() {
        assertThatThrownBy(() -> PaginationParameters.of(0, 10, "passwordHash", "ASC", SORTS,
                "createdAt", Sort.Direction.DESC, "id"))
                .isInstanceOf(BusinessException.class);
    }
}
