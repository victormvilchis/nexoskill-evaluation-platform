...
class PublicIdNormalizerTest {
    ...
    void preservesCanonicalUuidWithLetters() {
        ...
        assertThat(PublicIdNormalizer.requiredUuid(value, "REQUIRED", "Required"))
                .isEqualTo(value);
    }

    @Test
    void canonicalizesUppercaseUuidWithoutChangingItsIdentity() {
        assertThat(PublicIdNormalizer.requiredUuid(
    ...
    void rejectsInvalidPublicId() {
        assertThatThrownBy(() -> PublicIdNormalizer.requiredUuid(
                "not-a-uuid",
                "REQUIRED",
                "Required"
        ))
