...
class StudentJpaEntityTest {
	...
	void movesTheSameIdentityToTalentBankAndPreservesHistoricalData() {
		StudentJpaEntity student = StudentJpaEntity.create("student-public-id", 20L, "STU-001", "student@nexoskill.mx",
				"student@nexoskill.mx", "hash", "Ana", "López", "Ana López", StudentStatus.ACTIVE, TODAY.minusDays(30),
				TODAY.plusDays(30), TODAY.minusDays(15), "XMF7210", "XMF7210", NOW.plus(Duration.ofDays(7)), 1L,
