...
class ProfessionalCertificationProfileJpaEntityTest {
    ...
    void preservesOrganizationalOwnership() {
        ...
        ProfessionalCertificationProfileJpaEntity profile =
                ProfessionalCertificationProfileJpaEntity.create(
                        "00000000-0000-0000-5000-000000000001", "JAVA_STD", "Java STD",
                        "Perfil organizacional", 10, "DEVELOPER", ContentScope.ORGANIZATION,
                        25L, 8L, now);
