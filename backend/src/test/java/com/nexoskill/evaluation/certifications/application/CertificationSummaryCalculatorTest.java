...
class CertificationSummaryCalculatorTest {
    ...
    void shouldKeepExpiringSoonAndNonExpiringApprovedAreasInsideValidTotal() {
        ...
        List<CycleView> cycles = List.of(
                approved(CertificationType.TECHNOLOGICAL, CertificationValidityStatus.VALID),
    ...
    void shouldNotTreatAnExpiredPreviouslyApprovedAreaAsInitialPending() {
        ...
        CycleView expired = approved(CertificationType.DEVELOPMENT_SECURITY,
    ...
    void shouldClassifyInitialPendingScheduledAndFailedAreasWithoutDoubleCountingThem() {
        ...
        CycleView scheduled = cycle(CertificationType.TECHNOLOGICAL, false,
    ...
    private static CycleView approved(CertificationType type, CertificationValidityStatus validity) {
        ...
        return cycle(type, false, CertificationTrackingStatus.APPROVED, CertificationExamStatus.PASSED,
                validity, nonExpiring ? null : approvedDate, nonExpiring ? null : approvedDate, true);
    }
    ...
    private static CycleView cycle(CertificationType type, boolean recertification,
        ...
        LocalDate expirationDate = validityStatus == CertificationValidityStatus.NOT_OBTAINED
                ? null : LocalDate.of(2026, 7, 11);
        return new CycleView(
                type.name() + "-" + trackingStatus.name(),
                type,
