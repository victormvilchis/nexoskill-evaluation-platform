...
class CertificationDeadlineCalculatorTest {
	...
	void developmentSecurityUsesCalendarMonthsAndFifteenDays() {
		assertThat(CertificationDeadlineCalculator.calculate(LocalDate.of(2026, 1, 31), 2, 15))
				.isEqualTo(LocalDate.of(2026, 4, 15));
	}

	@Test
	void normativeUsesTwoCalendarMonths() {
		assertThat(CertificationDeadlineCalculator.calculate(LocalDate.of(2026, 1, 31), 2, 0))
				.isEqualTo(LocalDate.of(2026, 3, 31));
	}

	@Test
	void unconfiguredPolicyDoesNotInventADeadline() {
		assertThat(CertificationDeadlineCalculator.calculate(LocalDate.of(2026, 1, 10), null, null)).isNull();
	}
}
