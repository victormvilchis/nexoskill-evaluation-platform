...
class QuestionValidatorTest {
    ...
    void rejectsDuplicateOptionsIgnoringCaseAndWhitespace() {
        BusinessException exception = assertThrows(
                ...
                () -> validator.validate(
                        ...
                        List.of(
                                option("Java   Engineer", true),
                                option(" java\tengineer ", false)),
                        null));
    ...
    void rejectsDuplicateCategories() {
        BusinessException exception = assertThrows(
                ...
                () -> validator.validate(
                        QuestionTypeCode.SINGLE_CHOICE,
                        "Pregunta",
                        List.of("category-id", "category-id"),
                        QuestionAnswerSettings.empty(),
    ...
    void acceptsOpenTextWithManualReview() {
        assertDoesNotThrow(() -> validator.validate(
                QuestionTypeCode.OPEN_TEXT,
                "Explica",
                List.of("cat"),
                new QuestionAnswerSettings(List.of(), false, true, null, null, null, 1_000),
                List.of(),
                null));
    }
    ...
    void matchingRequiresContentInBothColumns() {
        BusinessException exception = assertThrows(
                ...
                () -> validator.validate(
                        ...
                        QuestionAnswerSettings.empty(),
                        List.of(
                                new QuestionOptionCommand("Clase", null, "", null, true, null),
    ...
    void acceptsMatchingPairs() {
        assertDoesNotThrow(() -> validator.validate(
                ...
                QuestionAnswerSettings.empty(),
                List.of(
                        new QuestionOptionCommand("Clase", null, "Plantilla", null, true, "Repasa POO"),
    ...
    void rejectsInvalidMaximumResponseLength() {
        BusinessException exception = assertThrows(
                ...
                () -> validator.validate(
                        ...
                        "Explica",
                        List.of("cat"),
                        new QuestionAnswerSettings(List.of(), false, true, null, null, null, 0),
                        List.of(),
                        null));
