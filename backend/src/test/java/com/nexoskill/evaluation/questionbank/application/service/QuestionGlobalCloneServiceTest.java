...
class QuestionGlobalCloneServiceTest {
    ...
    private final QuestionGlobalCloneService service = new QuestionGlobalCloneService(
            questions, promotions, promotionService, tenantContextResolver, request, audit, Clock.systemUTC());
    ...
    void organizationalUserCannotPrepareCloneToGlobal() {
        ...
        assertThatThrownBy(() -> service.preview("question-id"))
