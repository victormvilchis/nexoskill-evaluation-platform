...
class QuestionAvailabilityServiceTest {
	...
	private final QuestionAvailabilityService.Actor actor = new QuestionAvailabilityService.Actor(7L, "127.0.0.1",
			"test");

	@Test
	void availabilityModeIsRequiredAndNeverDefaultsToGlobalPublication() {
		assertThatThrownBy(() -> service.update("11111111-1111-1111-1111-111111111111",
	...
	void availabilityChangeRequiresAnAuthenticatedActor() {
		assertThatThrownBy(() -> service.update("11111111-1111-1111-1111-111111111111",
				new QuestionAvailabilityService.UpdateCommand(QuestionAvailabilityMode.NONE, List.of()),
				TenantContext.global(1L, "global", "GLOBAL"), null)).isInstanceOf(BusinessException.class)
