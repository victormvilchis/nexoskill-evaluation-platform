        ...
        <div className="ns-data-table-wrap">
          ...
          {!loading && data?.content.map((student) => <tr key={student.publicId}>
            ...
            <td className="ns-actions-column"><TableActions>
              ...
              {student.certificationsEnabled && (administrator || permissions.has('STUDENT_CERTIFICATION_VIEW') || permissions.has('STUDENT_CERTIFICATION_MANAGE')) && <TableActionLink icon="clipboard" label="Certificaciones" to={`/admin/collaborators/${student.publicId}/certifications`} />}
